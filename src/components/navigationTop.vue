<template>
  <div class="nav-top xmf-flex">
    <el-menu class="el-menu-demo nav-menu" mode="horizontal">
      ...
      <el-menu-item index="7" disabled class="item">耳机音响</el-menu-item>
      <el-menu-item index="8" disabled class="item">路由器</el-menu-item>
      <el-menu-item index="9" disabled class="item">显示器</el-menu-item>
      <el-menu-item index="10" disabled class="item">照相机</el-menu-item>
      <el-menu-item index="11" disabled class="item">打印机</el-menu-item>
      <el-menu-item index="12" disabled class="item">投影仪</el-menu-item>
      <el-menu-item index="4" disabled class="item">电视机</el-menu-item>
      <el-menu-item index="5" disabled class="item">冰箱</el-menu-item>
      <el-menu-item index="6" disabled class="item">洗衣机</el-menu-item>
    </el-menu>
  </div>
</template>
